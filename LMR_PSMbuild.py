...
class v_core(object):
    ...
    anom_reference_period = (1961,1990) #(1951,1980)
    ...
    calib_period = (1880,2019) # (1850, 2015)
...
class v_proxies(object):
    ...
    class _PAGES2kv1(object):
        ...
        proxy_timeseries_kind = 'anom' # 'anom' for anomalies (temporal mean removed) or 'asis' to keep unchanged
    ...
    class _LMRdb(object):
        ...
        proxy_timeseries_kind = 'anom' # 'asis' or 'anom' for anomalies (temporal mean removed) or 'asis' to keep unchanged
        ...
        proxy_order = [
            ...
            #'Corals and Sclerosponges_Temperature',#same as Composite error
            ]
...
class v_psm(object):
    ...
    # will be considered.
    test_proxy_seasonality = True #False in production setup!
	...
	# or 
        datatag_calib = 'GISTEMP_NicBrom'
        #datafile_calib = 'merged_gistempERSSTv5_nicolasbromwich_eraia_195801-201212.nc'
        datafile_calib = 'merged_gistempGHCNv4ERSSTv5_nicolasbromwich_eraif_188001-201912.nc'
        # or
	...
	# or 
        ...
        datafile_calib_T = 'merged_gistempGHCNv4ERSSTv5_nicolasbromwich_eraif_188001-201912.nc'
        # or
