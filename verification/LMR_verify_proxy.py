...
# min nb of obs to consider for verif. statistics
obcount_min = 50 # ok for Common Era recons
#obcount_min = 10 # test for LGM/Holocene recons.
...
for dir in dirset:
    ...
    Xprior_statevector = np.load(file_prior,allow_pickle=True)
