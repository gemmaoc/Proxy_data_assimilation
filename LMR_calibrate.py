...
def calibration_assignment(icalib):
    ...
    elif icalib == 'GISTEMP_NicBrom':
        calib_object = calibration_GISTEMP_NicBrom()
    elif icalib == 'HadCRUT':
...
# -------------------------------------------------------------------------------
# *** GISTEMP Nicolas Bromwich class --------------------------------------------
# -------------------------------------------------------------------------------
class calibration_GISTEMP_NicBrom(calibration_master):

    source = 'GISTEMP_NicBrom'
    dataformat_calib = 'NCD'
    calib_vars = ['Tsfc']
    outfreq = 'monthly'
    ...
    # read the data
    def read_calibration(self):
        from load_gridded_data import read_gridded_data_GISTEMP_NicBrom
        [self.time,self.lat,self.lon,self.temp_anomaly] = read_gridded_data_GISTEMP_NicBrom(self.datadir_calib,
                                                                                    self.datafile_calib,
                                                                                    self.calib_vars,
                                                                                    self.outfreq,
                                                                                    self.anom_reference_period)
