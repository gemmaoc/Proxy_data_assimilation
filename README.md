...
Repo containing code for conducting proxy data assimilation using the ensemble Kalman filter. Adapted from code created by Greg Hakim's group at the Unviersity of Washington. 
