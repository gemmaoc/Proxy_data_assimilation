...
def main():
    ...
    include_NCDC = True
    include_PAGES2kphase2 = False #True #False for pseudo
    ...
    #LMRdb_dbversion = 'vGKO1_pseudo_PACE'
    LMRdb_dbversion = 'vGKO1_pseudo_CESM_hist_monthly'
    ...
    eliminate_duplicates = False #True #False for pseudo
    ...
    datadir = '/home/disk/eos12/goconnor/data/proxies/'
    ...
    outdir = '/home/disk/eos12/goconnor/data/proxies/'
        ...
        for key in sorted(proxy_def.keys()):
            ...
            if pages2k_data[counter]['archiveType'] == proxy_archive \
               and pages2k_data[counter]['paleoData_variableName'] in proxy_def[key]:
                ...
                print(' ... proxy archive and/or variable (%s / %s) not present in proxy_def. Record not included in db'
                      %(pages2k_data[counter]['archiveType'],pages2k_data[counter]['paleoData_variableName']))
    ...
    if os.path.isfile(filename):
        ...
        for line in VarDesc:  # handle all the NCDC convention changes
            ...
            if line and line[0] != '' and line[0] != ' ' and line[0:2] != '#-' and line[0:2] != '# ' and line != '#':
                ...
                #print('len of sp_line',len(sp_line))
                if len(sp_line) < 9:
                    nvar = 0 #added by GKO on 12/3 because it was counting vars in meta lines
                    continue
                else:
                    #print('getting short name for nvar',nvar)
...
#               'Seasonality', 'Databases']
    ...
    if output_format == 'pickle':
        ...
        #df = df.to_sparse()#commented out on 8/19/20 by GKO I think sparse isn't a thing anymore?
